...
class QMIX:
    ...
    def save_model(self, run_num, train_step):
        ...
        torch.save(self.eval_qmix_net.state_dict(), self.model_dir + '/' + str(run_num) + "_" + num + '_qmix_net_params.pkl')
        torch.save(self.eval_rnn.state_dict(),  self.model_dir + '/' + str(run_num) + "_" + num + '_rnn_net_params.pkl')
