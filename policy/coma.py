...
class COMA:
    def __init__(self, args):
        ...
        # input: state_shape 48 .obs_shape 30  .n_agents 3    .n_actions 9*3*2
        ...
        # rnn_parameters:
        # 0、1 为fc1参数 6 7为fc2参数
        # 2-5为gru参数 共12部分 64入 64*3出的b和w个两组
    ...
    def _train_critic(self, batch, max_episode_len, train_step):
        ...
        # eval_critic更新200次后 target_critic 更新一次
